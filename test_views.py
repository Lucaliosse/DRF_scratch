...
class TestCategoryViewset:
    ...
    def test_list_categories_returns_only_active(self, api_client, category_active, category_inactive):
...
class TestProductViewset:
    ...
    def test_list_products_returns_only_active(self, api_client, product_active, product_inactive):
    ...
    def test_filter_products_by_category_id(self, api_client, category_active, product_active):
